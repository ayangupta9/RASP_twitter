...
export function FeedbackForm({ image, prediction, platform, onSubmitFeedback, onFeedbackComplete }: FeedbackFormProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (onFeedbackComplete) onFeedbackComplete() // Call this immediately after successful submission
    } catch (error) {
    ...
    <div className="space-y-4 mt-4">
      ...
      {feedbackSubmitted ? (
        ...
        <>
          ...
          <Button onClick={handleSubmit} disabled={!feedbackValue} className="w-full">
            Submit Feedback
          </Button>
        </>
      )}
